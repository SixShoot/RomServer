...
public:
	...
	char* GetString(const string Name);
	void PushValue(const string Name, const string Value);
	void PushValue(const string Name, int Value);
	void PushValue(const string Name, UINT64 Value);
	UINT64 GetUINT64(const string Name);
};
template <class T >
class Pointer
{
...
class MyFloat
{
#define _MyFloat_SMATH_EPSILON 1.0e-4f
