...
*/
	...
	public:
		virtual ~WMemberBase() {};
		wstring toString(){return m_sValue;};
		const wchar_t* c_str() {return m_sValue.c_str();};
		wstring *getStringPtr() {return &m_sValue;};
	};

	class xWString: public WMemberBase
	{
	private:
		void AssignValue(const wstring value){m_sValue=value;};
	public:
		xWString(){};
		xWString(wstring value) {AssignValue(value);};
		wstring value(){return m_sValue;};
		xWString operator=(const wstring value) {AssignValue(value);return *this;};
		xWString operator=(const wchar_t* value) {AssignValue(value);return *this;};
	};
